...
<h3>優惠券搜尋結果</h3>
<hr>
<input type="button" value="返回列表" onclick="location.href='./couponRel.php'">
<hr>
        ...
        <tbody>
            ...
            ?>
                <tr>
                    ...
                    <td class="couponborder">
                        <a href="./editRel.php?editId=<?php echo $arr[$i]['id']; ?>">編輯</a>
                        <a href="./deleteRel.php?deleteRelId=<?php echo $arr[$i]['id']; ?>">刪除</a>
                    </td>
                </tr>
            <?php
                }
