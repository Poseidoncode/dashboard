    ...
    ?>
      ...
      <form class="form-signin my-2 my-md-0 box" name="myForm" method="post" action="./login.php">
          ...
          <div class="checkbox mb-3">       
            <label class="text-white mx-1">會員        
              <input class="form-control mx-1" type="radio" name="identity" value="member" checked />
            </label>
            <label class="text-white mx-1">廠商
              <input class="form-control mx-1" type="radio" name="identity" value="company" />
            </label>
            <label>
