        ...
        ?>
            <tr>
                ...
                <td class="border_article">
                    ...
                    <input type="button" value="單筆刪除" onclick="if(confirm('是否確認刪除這筆資料？')) location.href='./articleDelete.php?deleteId=<?= $arr[$i]['articleId'] ?>'">
                    
                    <!-- <a href="./deleteIds.php?deleteId=<?php echo $arr[$i]['articleId']; ?>">DELETE</a> -->
