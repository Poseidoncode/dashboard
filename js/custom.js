$(document).ready(function(){
    ...
    $(document).on("click", "button#btn_addCart", function(e){
        ...
        $.ajax({
            ...
            dataType: "json",
            data: { 
                productId: btn.attr('data-item-id'), 
    ...
    $(document).on("click", "button#btn_addItemTracking", function(){
        ...
        .done(function( json ) {
            alert(json.info);
            $('span#wishItemNum').text(json.wishItemNum);
        })
        .fail(function( jqXHR, textStatus ) {
            alert( "Request failed: " + textStatus );
        });
    ...
    $(document).on("click", "input#btn_insertComments", function(){
        $.ajax({
            ...
            data: { 
                ...
                productId: $("input#productId[type='hidden']").val(), 
            ...
            <div class="row">
                <div class="media">
                    ...
                    <div class="media-body">
                        <h5 class="mt-0">${json.data.status}</h5>
 ...
 $(document).on("click", "input#btn_insertComment_reply", function(){
    $.ajax({
        ...
        dataType: "json",
        data: { 
            comment_replyContent: $("textarea[name='adminReply']").val()
        }
    })
    .done(function( json ) {
        alert(json.info);
